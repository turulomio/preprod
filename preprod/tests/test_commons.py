...
preprod_commons.git_clone("https://github.com/turulomio/pydicts", "", "main")
    """)
    assert path.exists(f"{tmp_test_path}/preprod/.git/")
    assert path.exists(f"{tmp_test_path}/preprod2/.git/")
    assert path.exists(f"{tmp_test_path}/preprod3/.git/")
    assert path.exists(f"{tmp_test_path}/pydicts/.git/")
